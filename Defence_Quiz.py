...
from google.ai.generativelanguage_v1beta.services.cache_service import CacheServiceAsyncClient
import time
import base64

# Apply custom CSS to make all text white
st.markdown(
    """
    <style>
...
def main():
    ...
    add_custom_styles()
    set_background_image(get_base64_of_bin_file(r"C:\Users\Nitya\Downloads\SentinelSecure\Quiz_BG.jpg"))
